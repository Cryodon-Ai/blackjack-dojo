...
export const TIERS = [
  ...
  {
    id: 7, title: 'Variants & Side Bets', sub: 'What you will actually meet online', kind: 'quiz', gen: 't7', secs: 4,
    outcome: 'You recognize the twist, know what it costs, and decline every side bet under pressure.',
    lessons: [
      { t: 'Free Bet Blackjack', html: `<p>The casino pays for your double downs (hard 9–11) and pair splits (not 10s) — so if you lose you lose <i>your original bet only</i>. The price: <b>a dealer 22 pushes</b> instead of busting, so a common way for the dealer to break stops paying you. Quoted house edge: <b>~1.04%</b> <span class="pill">quoted, not re-derived</span>. As commonly described: take every free double and free split — check the game's own rules screen for the exact list.</p>` },
      { t: 'Lightning, Power, Infinite, Switch, Spanish 21', html: `<p><b>Infinite Blackjack</b>: ordinary rules, unlimited players — basic strategy applies. <b>Blackjack Switch</b>: you get two hands and may swap top cards; blackjack pays 1:1 and dealer 22 pushes — different strategy. <b>Spanish 21</b>: no tens in the deck, with bonus payouts. <b>Lightning / Power</b> style games attach random multipliers to some outcomes.</p><p>I have not verified any of these paytables against a source, so <b>no house edge is claimed for them here</b> <span class="pill due">unverified</span>. Read the game's own info screen.</p>` },
      { t: 'Side bets: what they cost', html: `<p>Computed exactly, 6 decks: <b>insurance {{ins}}</b>; <b>Perfect Pairs</b> (25/12/6) about <b>6.1%</b>; <b>21+3</b> (5/10/30/40/100) about <b>4.6%</b>. Compare with the main game at ~0.4%. Every one of them is far more expensive per dollar.</p>` },
      { t: 'Random multiplier drops', html: `<p>Games that drop random multipliers on side bets (pairs, dealer bust, poker) are advertising the payout, not the odds. A multiplier changes how big a rare win is, never how often it happens. <b>Decline.</b> The Trap Mode drill throws them at you.</p>` },
    ],
    guided: [],
  },
  {
